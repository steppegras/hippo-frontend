    ...
    <div>
      ...
      <div className="mt-6">
        ...
        <div className="flex w-full mt-4">
          <NumberInput
            className="grow mr-4 rounded-xl bg-primaryGrey min-w-0"
            name="slipTolerance"
            min={0}
            max={100}
            placeholder="0.00%"
          ...
          />
          <Button className="py-[6px] font-bold" variant="outlined" onClick={handleAuto}>
            Auto
          </Button>
        </div>
      </div>
      <div className="mt-6">
        ...
        <div className="flex w-full mt-4 h-[39px] items-center">
          <NumberInput
            className="w-[88px] h-full mr-4 rounded-xl bg-primaryGrey min-w-0"
